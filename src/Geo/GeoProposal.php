...
final class GeoProposal {
    ...
    public function __construct(public readonly GeoProposalId $id, public readonly string $articleSlug, public readonly string $inputChecksum, public readonly string $type, public readonly array|string $value, public readonly string $status = 'pending', ?string $bodyHash = null) {
