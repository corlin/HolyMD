...
final class EndpointPolicyTest extends TestCase {
 ...
 public static function nonGlobalAddresses(): array { return array_map(static fn(string $ip):array=>[$ip],['0.0.0.0','10.0.0.1','100.64.0.1','127.0.0.1','169.254.1.1','172.16.0.1','192.0.0.1','192.0.2.1','192.168.1.1','198.18.0.1','198.51.100.1','203.0.113.1','224.0.0.1','240.0.0.1','255.255.255.255','::','::1','fc00::1','fe80::1','ff00::1','2001:db8::1','::ffff:10.0.0.1','::ffff:192.168.1.1']); }
}
