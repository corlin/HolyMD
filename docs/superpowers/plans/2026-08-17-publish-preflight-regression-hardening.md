...
- [ ] **Step 1: Write failing timezone and formatter tests**
...
- [ ] **Step 3: Implement validated timezone and formatter**
...
- [ ] **Step 4: Write and verify a failing real-MySQL connection test**
...
- [ ] **Step 5: Normalize PDO sessions and add the idempotent migration**
...
- [ ] **Step 6: Inject the formatter into administrator data/view boundaries**
...
- [ ] **Step 1: Write a failing behavior test using a real SQLite score table**
...
- [ ] **Step 2: Run the test and verify the worker composition path is still uncovered**
...
- [ ] **Step 3: Inject standard PDO and calculator in the CLI composition root**
...
- [ ] **Step 4: Make score-recording failure observable without reversing publication**
...
- [ ] **Step 3: Implement the mobile controls and accessible heading**
...
- [ ] **Step 4: Run focused tests and JavaScript syntax validation**
...
- [ ] **Step 1: Write a failing clean/warning preflight test**
...
- [ ] **Step 3: Implement the immutable result and minimal candidate-set validation**
...
- [ ] **Step 4: Add a failing blocker test**
...
- [ ] **Step 5: Implement blocker collection without throwing away other findings**
...
- [ ] **Step 6: Add and pass published-score comparison tests**
...
- [ ] **Step 1: Write failing controller tests for warning and blocker flows**
...
- [ ] **Step 3: Implement server-rendered preflight**
...
- [ ] **Step 4: Write failing acknowledgement-binding tests**
...
- [ ] **Step 5: Enforce preflight in publish and preserve CAS ordering**
...
- [ ] **Step 6: Enhance the editor submission path**
